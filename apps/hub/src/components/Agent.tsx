...
export const Agent: React.FC<AgentProps> = ({ subname }) => {
  ...
  return (
    <Link href={`/chat/${subname.ens}`} className="p-5 rounded-lg bg-background border-border hover:shadow-md transition-shadow border-[1px] gap-5 flex flex-row items-center">
