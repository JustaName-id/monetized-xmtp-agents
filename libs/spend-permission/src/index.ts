...
export const spendPermissionManagerAbi = [
    ...
    "inputs": [
      {
        ...
        "type": "tuple",
        "internalType": "struct ExtendedSpendPermissionManager.SpendPermission",
        "components": [
          {
            "name": "account",
            "type": "address",
    ...
    "inputs": [
      {
        ...
        "type": "tuple",
        "internalType": "struct ExtendedSpendPermissionManager.SpendPermissionBatch",
        "components": [
          {
            "name": "account",
            "type": "address",
          ...
          },
          {
            "name": "permissions",
            "type": "tuple[]",
            "internalType": "struct ExtendedSpendPermissionManager.PermissionDetails[]",
            "components": [
              {
                "name": "spender",
                "type": "address",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        ...
        "type": "tuple",
        "internalType": "struct ExtendedSpendPermissionManager.PeriodSpend",
        "components": [
          {
            "name": "start",
            "type": "uint48",
  ...
  {
    "type": "function",
    "name": "getSpendRequestHash",
    "inputs": [
      {
        "name": "spendRequest",
        "type": "tuple",
        "internalType": "struct ExtendedSpendPermissionManager.SpendRequest",
        "components": [
          {
            "name": "account",
            "type": "address",
  ...
  {
    "type": "function",
    "name": "revokeAsSpenderWithSignature",
    "inputs": [
      {
        "name": "spendPermission",
        "type": "tuple",
