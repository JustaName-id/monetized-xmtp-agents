          ...
          <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuGroup>
                ...
                {claimedSubname &&
                  <DropdownMenuItem className="cursor-pointer hover:bg-secondary" onClick={() => openEnsProfile(claimedSubname.ens, mainnet.id)}>
                    <User />
                    <p className="text-popover-foreground font-normal text-base">Profile</p>
                  </DropdownMenuItem>
                }
                {!claimedSubname &&
                  <DropdownMenuItem
