...
export const AgentSelector: React.FC = () => {
     // TODO: use the slug to get the selected agent and get from the validSubscriptions the rest,
     //  also refactor the <Avatar/> with the image and text into a separate component in order to use inside the useAgentDetails and useSubname
    //
